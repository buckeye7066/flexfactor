...
interfaces: Refactor, Scout, Audit, and Production Ready. Version 0.6.0 uses one
...
Android 3.5.0 is a native phone interface, not a Termux or desktop remote-control
