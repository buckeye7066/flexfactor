...
class ProductInvariantTests(unittest.TestCase):
    ...
    def test_runtime_hard_wires_the_invariant_into_completion_and_release(self):
        ...
        self.assertIn('getattr(args, "competitor_count", _ff_execution.TOP_COMPETITORS)', source)
