...
```bash
python C:\Users\firer\aibus\aibus.py post --from <agent> --topic flexfactor "..."
python C:\Users\firer\aibus\aibus.py note --from <agent> --title "..." --tag flexfactor "..."
```

Use the topic `flexfactor` for this repo — one topic per subject of work, not per session.
